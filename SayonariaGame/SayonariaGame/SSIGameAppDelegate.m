...
@implementation SSIGameAppDelegate
...
- (void)applicationDidBecomeActive:(UIApplication *)application
{
    ...
    [[UIApplication sharedApplication] setStatusBarHidden:YES withAnimation:0];
    if (self.didQuitAlready == [NSNumber numberWithInt:1]) {
        [self.currentNetworkController initNetworkCommunication];
        self.didQuitAlready = [NSNumber numberWithInt:0];
    }
}
